...
-- NOTE: MySQL refuses to run this query, saying it can't find P.CategoryID referenced in
--       the WHERE clause.  This query runs just fine in other database systems.
